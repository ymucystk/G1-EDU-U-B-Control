  ...
  return (
    <>
      <div className="controller" >
        ...
        <div className="row mb-2">
          <div className="col-md-4"><label htmlFor="r9_rotate_number" className="form-label"><span className="form-control-plaintext">R9 Deg</span></label></div>
        ...
        <div className="row mb-2">
          <div className="col-md-4"><label htmlFor="l9_rotate_number" className="form-label"><span className="form-control-plaintext">L9 Deg</span></label></div>
